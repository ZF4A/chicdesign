...
const fallbackProducts: ProductItem[] = [
  { id: 1, name: "Plateau décoratif en résine", nameEn: "Decorative Resin Tray", price: 15000, category: "resin", image: "/images/3.jpg", stock: 20, featured: 1, description: "Plateau décoratif en résine. Couleurs : rose poudré et doré. Format moyen.", descriptionEn: "Decorative resin tray. Powder pink & gold. Medium size." },
  { id: 2, name: "Sculpture couple + coupelle", nameEn: "Couple Sculpture + Dish", price: 10000, category: "gypsum", image: "/images/20.jpg", stock: 8, featured: 1 },
  { id: 3, name: "5 Dessous de verre en résine (forme coquillage)", nameEn: "5 Resin Coasters (Shell)", price: 5000, category: "resin", image: "/images/6.jpg", stock: 12, featured: 0, description: "Cinq dessous de verre en résine, finition nacrée et bord doré.", descriptionEn: "Five pearly resin coasters with gold rim." },
  { id: 4, name: "2 pots décoratifs + bibelo + plateau", nameEn: "2 Decorative Pots + Trinket + Tray", price: 25000, category: "gypsum", image: "/images/7.jpg", stock: 15, featured: 0, description: "Ensemble décoratif en gypse, pièces assorties pour table.", descriptionEn: "Gypsum decorative set, matching pieces for table." },
  { id: 5, name: "Sol en résine (effet marbre liquide)", nameEn: "Resin Floor (Liquid Marble)", price: 1000000, category: "resin", image: "/images/8.jpg", stock: 6, featured: 1, description: "Sol en résine imitation marbre, finition lisse et brillante.", descriptionEn: "Resin floor with liquid marble effect, smooth glossy finish." },
  { id: 6, name: "Sculpture couple + coupelle", nameEn: "Couple Sculpture + Dish", price: 10000, category: "gypsum", image: "/images/5.jpg", stock: 10, featured: 0, description: "Sculpture romantique en gypse avec petite coupelle.", descriptionEn: "Romantic gypsum sculpture with small dish." },
  { id: 7, name: "Vase double boule", nameEn: "Double Sphere Vase", price: 15000, category: "resin", image: "/images/10.jpg", stock: 18, featured: 0, description: "Vase moderne en résine, deux sphères imbriquées.", descriptionEn: "Modern resin vase with two interlocking spheres." },
  { id: 8, name: "Pack rose marbré", nameEn: "Marbled Rose Pack", price: 10000, category: "gypsum", image: "/images/11.jpg", stock: 7, featured: 1, description: "Pack de pièces marbrées roses en gypse.", descriptionEn: "Marbled rose gypsum pieces pack." },
  { id: 9, name: "Horloge murale en résine (style géode)", nameEn: "Geode Style Resin Wall Clock", price: 25000, category: "resin", image: "/images/12.jpg", stock: 9, featured: 0, description: "Horloge résine style géode avec incrustations nacrées.", descriptionEn: "Geode-style resin wall clock with pearly inlays." },
  { id: 10, name: "1 Boîtes décorative + plateau + pot", nameEn: "Decorative Box + Tray + Pot", price: 10000, category: "gypsum", image: "/images/13.jpg", stock: 5, featured: 1, description: "Ensemble cadeau : boîte décorative, plateau et petit pot.", descriptionEn: "Gift set: decorative box, tray and small pot." },
];
